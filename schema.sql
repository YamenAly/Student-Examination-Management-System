...
CREATE TABLE IF NOT EXISTS Student_Track (
	...
	CONSTRAINT fk_studentTrack_student FOREIGN KEY (StudentID) REFERENCES Student(StudentID),
	CONSTRAINT fk_studentTrack_track FOREIGN KEY (TrackID) REFERENCES Track(TrackID)
);
